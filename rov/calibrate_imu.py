...
def calibrate_gyro(imu, duration_s=5.0):
    ...
    sapmayi (GYRO_BIAS) hesaplar. Ideal jiroskop durgun halde 0 okumali;
    olculen ortalama gercek okumadan cikarilarak sapma giderilir."""
...
def main():
    ...
    print("\nBitti. Simdi 'python3 main.py --test-motors' ya da "
          "'python3 main.py' calistirabilirsin.")
